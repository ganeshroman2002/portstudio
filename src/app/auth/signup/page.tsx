      ...
      <div className="w-full lg:w-1/2 h-full overflow-y-auto flex flex-col p-4 sm:p-8">
        <div className="w-full max-w-[420px] m-auto bg-white rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 shrink-0">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-1.5">Create an Account</h2>
            <p className="text-xs sm:text-sm text-slate-500">Join PortStudio as a {role === 'talent' ? 'Creative/Professional' : 'Company'}</p>
          </div>
          ...
          <div className="flex bg-slate-100 p-1 rounded-xl mb-6">
            <button 
              ...
              className={`flex-1 text-xs font-medium py-2 rounded-lg transition-all ${role === 'talent' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
            >
              Talent
            </button>
            <button 
              ...
              className={`flex-1 text-xs font-medium py-2 rounded-lg transition-all ${role === 'company' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
            >
              Company
            </button>
          </div>
